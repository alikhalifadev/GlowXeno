...
#[derive(Debug)]
pub struct GlowXenoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GlowXenoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GlowXeno processing");
    
    let mut processor = GlowXenoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GlowXenoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GlowXenoProcessor::new(false);
